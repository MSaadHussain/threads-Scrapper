...
console.log(`Scheduled age controls: ${await page.locator("[data-query-age]").count()}`);
console.log(`Scheduled location controls: ${await page.locator("[data-query-location]").count()}`);
await page.screenshot({ path: "dashboard-searches.png", fullPage: true });
